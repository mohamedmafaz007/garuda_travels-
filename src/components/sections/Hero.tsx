...
import { MapPin, Calendar, Users, ArrowRight, ChevronDown, Phone, Send, ArrowLeftRight } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[90rem] flex-col justify-center px-4 pt-28 pb-20 sm:px-6 lg:px-8 lg:pt-0 lg:pb-0">
          ...
          <div className="flex w-full justify-center md:col-span-5 md:justify-end xl:col-span-5 mt-4 md:mt-0">
            ...
            >
              ...
              <div className="space-y-3.5">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="flex items-center gap-1.5 text-xs font-semibold text-navy-700">
                    <ArrowLeftRight className="h-3.5 w-3.5 text-gold-600 shrink-0" />
                    Trip Type
                  </label>
                  <div className="relative">
                    <select
